    ...
    <div className="container bg-light">
      ...
      <div className="row bg-light">
        ...
        <div className="col">
          <div className="row py-3">
            <h4 className="">COMPOSITE TYPES</h4>
          </div>
          <div className="border-bottom row py-3">
            <h5 className="">{compositeText}</h5>
          </div>
        </div>
      </div>
      <div className="row pt-3">
        <div className="col border-bottom">
          ...
          <div className="row py-3">
            <h5 className="">
              <ReactMarkdown>{vectorText}</ReactMarkdown>
            </h5>
          </div>
        </div>
        <div className="col">
      ...
      <div className="row py-3">
        ...
        <div className="col">
          ...
          <div className="row py-4">
            <h5>
              <ReactMarkdown>{listText}</ReactMarkdown>
            </h5>
          </div>
        </div>
      </div>
      <div className="row py-4 text-center"></div>
