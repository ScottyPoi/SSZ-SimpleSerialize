...
import MerkleDisplayList from "../display/MerkleDisplayList";
import MerkleDisplayContainer from "../display/MerkleDisplayContainer";

export default function MerkleContainerControls(props) {
    ...
    <>
      <div className="row justify-content-evenly">
        ...
        <div className="row pt-3">
          <MerkleDisplayContainer length={length} values={serialized} size={256}>
            {props.children}
          </MerkleDisplayContainer>
      </div>
    </>
  );
}
